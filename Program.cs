...
static class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Current month: " + now.ToString("MM") + " (" + now.ToString("MMM") + ")" + " (" + now.ToString("MMMM") + ")");
        ...
        Console.WriteLine("Current time zone offset: " + now.ToString("zz") + " (" + now.ToString("zzz") + ")");
    }
}